...
LIBROS_DATA = [
    ...
    # ── Libro 4: La Hormiga Valiente ──
    {
        ...
        "preguntas": [
            ...
            # ─ 6 años: comprensión inferencial ─
    ...
    # ── Libro 5: El Pájaro que Aprendió a Volar ──
    {
        "slug": "pajaro_volar",
...
class Command(BaseCommand):
    help = 'Pobla la base de datos con los libros y preguntas de V&E Academy'
